...
import com.bgsoftware.superiorskyblock.island.upgrade.cost.TeamPointsUpgradeCost;
import org.bukkit.configuration.ConfigurationSection;

import java.math.BigDecimal;

public class TeamPointsUpgradeCostLoader implements UpgradeCostLoader {
    ...
    public UpgradeCost loadCost(ConfigurationSection upgradeSection) throws UpgradeCostLoadException {
        ...
        return new TeamPointsUpgradeCost(BigDecimal.valueOf(upgradeSection.getDouble("price")));
    }
